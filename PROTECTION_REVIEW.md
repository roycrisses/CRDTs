...
### System Components:
1. **Frontend (Vite + React + TypeScript + Fabric.js)**: Responsible for capturing user input, drawing onto an HTML5 canvas, and updating the local Yjs document (`Y.Doc`).
