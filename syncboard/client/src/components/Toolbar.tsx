...
import { MousePointer2, Square, Circle as CircleIcon, Type, StickyNote, Pencil, Trash2, Hand, ArrowRight, Grid } from 'lucide-react';
...
export const Toolbar: React.FC<ToolbarProps> = ({ activeTool, setActiveTool, onClear, snapToGrid, setSnapToGrid }) => {
  ...
  const drawingTools = tools.slice(2, 4);
  const shapeTools = tools.slice(4);
