...
import { MousePointer2, Square, Circle as CircleIcon, Type, StickyNote, Pencil, Trash2, ArrowUpRight, Hand } from 'lucide-react';
import { cn } from '../lib/utils';

export type Tool = 'select' | 'pencil' | 'hand' | 'rectangle' | 'circle' | 'text' | 'sticky' | 'arrow';
