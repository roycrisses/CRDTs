    ...
    <div className="fixed top-6 left-6 right-6 h-16 flex items-center justify-between px-6 bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 z-50">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="text-xs font-medium text-slate-400 bg-transparent border-none p-0 focus:ring-0 focus:text-slate-600 hover:text-slate-600 transition-colors w-32"
            />
            <div className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="group relative">
          ...
          <div className="absolute top-full right-0 mt-2 w-32 bg-white rounded-xl shadow-2xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
            <button
              onClick={() => onExport('png')}
              className="w-full text-left px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 first:rounded-t-xl"
            >
              Export as PNG
            </button>
            <button
              onClick={() => onExport('svg')}
              className="w-full text-left px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 last:rounded-b-xl"
            >
              Export as SVG
            </button>
          </div>
