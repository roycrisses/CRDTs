    ...
    <div className="fixed top-6 left-6 right-6 h-16 flex items-center justify-between px-6 bg-white/90 backdrop-blur-2xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-slate-200/50 z-50">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="text-xs font-medium text-slate-400 capitalize bg-transparent border-none outline-none focus:text-slate-600 focus:bg-slate-50 rounded px-1 -ml-1 transition-colors"
            />
            <div className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative group/export">
          ...
          <div className="absolute right-0 top-full mt-1 hidden group-hover/export:block bg-white rounded-lg shadow-xl border border-slate-100 p-1 min-w-[120px] z-[60]">
            <button
              onClick={() => onExport('png')}
              className="w-full text-left px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 rounded transition-colors"
            >
              PNG Image
            </button>
            <button
