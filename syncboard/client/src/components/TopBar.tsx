        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="text-xs font-semibold text-slate-500 bg-transparent border-none p-0 focus:ring-0 w-32 hover:text-indigo-600 transition-colors cursor-pointer"
